...
const helpTooltip = (message) => (
    <HoverCard openDelay={100} closeDelay={200} >
        <HoverCardTrigger asChild>
            <CircleHelp className={"w-[16px] h-[16px] transform translate-y-[-3px] translate-x-[3px] cursor-pointer"} />
        </HoverCardTrigger>
...
function InputWithIcon({ icon: Icon, labelText, htmlFor, helpMsg, children }) {
    return (
        <div className="flex flex-col">
            <Label className="flex px-1 mb-3 font-bold text-slate-300" htmlFor={htmlFor}>
